...
public abstract class ImageWorker {
    ...
    private static final int FADE_IN_TIME = 200;       //ͼƬ����Ķ���ʱ�� 

    private ImageCache mImageCache;   //���������
    private ImageCache.ImageCacheParams mImageCacheParams;  //�������
    private Bitmap mLoadingBitmap;             //��δ������ʱ����ʾ��ͼƬ (����ص�ͼƬ...)
    private boolean mFadeInBitmap = true;             //����Ч��ı�־
    private boolean mExitTasksEarly = false;
    protected boolean mPauseWork = false;               //�߳̿��ر�־(�Ƿ���ͣ�߳�)
    private final Object mPauseWorkLock = new Object();  //�̵߳� ��  (�о�����Ļ��ƻ����Ǻ�͸������ǰѧ�Ķ����ˡ�)
