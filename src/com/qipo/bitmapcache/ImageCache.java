...
public class ImageCache {
	...
	private DiskLruCache mDiskLruCache; // Ӳ���л���
	private LruCache<String, Bitmap> mMemoryCache; // �ڴ��еĻ���
	private ImageCacheParams mCacheParams; // ͼƬ����Ĳ���
	private final Object mDiskCacheLock = new Object(); // ��
	private boolean mDiskCacheStarting = true; // �߳̿�ʼ�ı�־
		...
		if (mCacheParams.memoryCacheEnabled) {
			...
			mMemoryCache = new LruCache<String, Bitmap>(
				...
				protected int sizeOf(String key, Bitmap bitmap) {
					return getBitmapSize(bitmap); // �÷���api(12)
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		// context.getCacheDir().getPath();
		// } else {
		// Toast.makeText(context, R.string.sd_card, Toast.LENGTH_SHORT)
		// .show();
	...
	public static String hashKeyForDisk(String key) {
		...
		try {
			...
			cacheKey = bytesToHexString(mDigest.digest()); // ժҪ ��ȫ�����
	...
	public static long getUsableSpace(File path) {
		...
		final StatFs stats = new StatFs(path.getPath()); // Construct a new
															// StatFs for
															// looking at the
															// stats of the
															// filesystem at
